...
export const heroOne = {
  ...
  description:
    "We have designed and implemented the best automotive detailing in our business",
...
export const herofour = {
  reverse: false,
  inverse: false,
  headline: "Our Shop Is Officially Open!",
  description:
    "We are thrilled to announce that our shop is now officially open for business! After months of preparation and hard work, we are excited to welcome customers to experience our exceptional services. Our team of skilled professionals is ready to provide top-notch solutions to meet all your automotive needs. Whether it's detailing, repairs, or maintenance, we are here to serve you with utmost dedication and expertise. We have created a welcoming and customer-centric environment where your satisfaction is our priority. Come visit us and discover the exceptional service and quality that sets us apart.",
};
